...
?>
                    ...
                    $query3=mysqli_query($con,"Select * from  tblapplyjob join tblvacancy on  tblvacancy.ID=tblapplyjob.JobId where tblvacancy.CompanyID='$cid' and tblapplyjob.Status='Sorted'");
